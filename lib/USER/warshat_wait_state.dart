...
class not_conferm_warshat_statues extends StatefulWidget {
  final country;
  final namefirst;
  final namelast;
  final image;
  ...
  final id;
  final name;
  not_conferm_warshat_statues({this.name,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _not_conferm_warshat_statues createState() =>  _not_conferm_warshat_statues();
}
class  _not_conferm_warshat_statues extends State<not_conferm_warshat_statues> {
