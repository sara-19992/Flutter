...
class delete_warshat_statues extends StatefulWidget {
  final country;
  final namefirst;
  final namelast;
  final image;
  ...
  final type;
  final name;
  delete_warshat_statues({this.name,this.from,this.to,this.type,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _delete_warshat_statues createState() =>  _delete_warshat_statues();
}
class  _delete_warshat_statues extends State<delete_warshat_statues> {
                    ...
                    child: Column(
                      children:[
                        Container(
                          ...
                          child: FlatButton(
                            onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => Search_user(country:widget.country,work:widget.work,name_Me: widget.name_Me,location: widget.country,namefirst_Me:widget.namefirst,nameLast_Me:widget.namelast,phone_Me: widget.phoneuser,image_Me: widget.image,),),);
