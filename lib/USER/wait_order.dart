...
class waitorder_statues extends StatefulWidget {
  final country;
  final namefirst;
  final namelast;
  final image;
  ...
  final id;
  final name;
  waitorder_statues({this.name,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _waitorder_statues createState() =>  _waitorder_statues();
}
class  _waitorder_statues extends State<waitorder_statues> {
