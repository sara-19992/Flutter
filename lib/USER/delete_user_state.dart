...
class delete_user_statues extends StatefulWidget {
  ...
  final name;
  final id;
  delete_user_statues({this.id,this.name,this.token,this.who,this.datecancel,this.timecancel,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
