...
class Search_map_avalibel extends StatefulWidget {
  final work;
  final name_Me;
  final namefirst_Me;
  final nameLast_Me;
  ...
  final location;
  final country;
  Search_map_avalibel({this.country,this.token_Me,this.image_Me,this.namefirst_Me,this.nameLast_Me,this.phone_Me,this.work,this.name_Me,this.location});
  // final location;
  //   final work;
  //  final name_Me;
...
class _mState extends State<Search_map_avalibel> {

  Future getMarker()async{
    var url='https://'+IP4+'/testlocalhost/marker_avalibel.php';
