...
class finished_user_statues extends StatefulWidget {
  final country;
  final namefirst;
  final namelast;
  final image;
  ...
  final id;
  final name;
  finished_user_statues({this.name,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _finished_user_statues createState() =>  _finished_user_statues();
}
class  _finished_user_statues extends State<finished_user_statues> {
