...
class waitwar_statues extends StatefulWidget {
  final country;
  final namefirst;
  final namelast;
  final image;
  ...
  final id;
  final name;
  waitwar_statues({this.name,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _waitwar_statues createState() =>  _waitwar_statues();
}
class  _waitwar_statues extends State<waitwar_statues> {
