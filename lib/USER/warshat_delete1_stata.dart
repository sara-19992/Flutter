...
class delete1_warshat_statues extends StatefulWidget {
  ...
  final type;
  final name;
  delete1_warshat_statues({this.name,this.from,this.to,this.type,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
  _delete1_warshat_statues createState() =>  _delete1_warshat_statues();
}
class  _delete1_warshat_statues extends State<delete1_warshat_statues> {
