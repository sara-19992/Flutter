            ...
            body: Form(
              ...
              child: Stack(
                ...
                children: <Widget>[
                  ...
                  //         margin: EdgeInsets.only(left: 100,top:0,bottom: 15),
                  //         decoration: BoxDecoration(
                  //           color:Colors.white,
                  ...
                  //   margin: press?EdgeInsets.only(top:390):EdgeInsets.only(top:520),
                  ...
                  //                             alignment: Alignment.topRight,
                  //                             child:Icon(Icons.check_circle,size: 30,color: step1?perp1:Colors.grey,),
                  //                           ),
                  //                           Container(
                  ...
                  //                             margin: EdgeInsets.only(top:5),
                  //                             alignment: Alignment.topRight,
                  //                             child:Icon(Icons.check_circle,size: 30,color: step2?perp1:Colors.grey,),
                  //                           ),
                  //                           Container(
                  //                             transform: Matrix4.translationValues(0.0, -5.0, 0.0),
                  //                             margin: EdgeInsets.only(top:0),
                  ...
                  //                             margin: EdgeInsets.only(top:0),
                  //                             alignment: Alignment.topRight,
                  //                             child:Icon(Icons.check_circle,size: 30,color: step3?perp1:Colors.grey,),
                  //                           ),
                  //                           Container(
                  //                             transform: Matrix4.translationValues(0.0, -5.0, 0.0),
                  //                             margin: EdgeInsets.only(top:0),
                  ...
                  children: [
                    Container(child:Row(
                      children: [
                        Container(
                          width:80,
                          child:Text('مدة الورشة', style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w700,
                            color: Colors.black87,
                            fontFamily: 'Changa',
                        ...
                        SizedBox(width:10,),
                        Text( "من  "+widget.from +"    إلى "+widget.to, style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
                          color: Colors.black54,
                          fontFamily: 'Changa',
