  ...
  Future<void> _dialogCall2() {
    return showDialog(
        ...
        builder: (BuildContext context) {
          return Directionality(textDirection: ui.TextDirection.rtl,
            child:delete_order(token:widget.token,name:widget.name,work:widget.work,lat:widget.lat,lng:widget.lng,Information:widget.Information,Experiance:widget.Experiance,chooseDate:widget.ChooseDate,phoneuser:widget.phoneuser,phoneworker:widget.phoneworker,image:widget.image,description:widget.description,datesend:widget.datesend,timesend:widget.timesend,id:widget.id,phone:widget.phoneworker,date:widget.date,namefirst: widget.namefirst,namelast:widget.namelast,time:widget.time,),);
        });
  }
}
...
class  _accept extends State<accept> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  widget.orderimage!=null && !press?Container(
                    ...
                    margin: EdgeInsets.only(left: 165,top:20,bottom: 5),
                    decoration: BoxDecoration(
                      // color:Colors.white,
                      color:Colors.red,
                    ...
                    child:Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            press=!press;
                            if(widget.orderimage==null)h=200;
                            else h=370;
                            setState(() {
  ...
  Future<void> _dialogCall2() {
    return showDialog(
        ...
        builder: (BuildContext context) {
          return Directionality(textDirection: ui.TextDirection.rtl,
            child:delete_order(name:widget.name,work:widget.work,token:widget.token,lng:widget.lng,lat:widget.lat,Information:widget.Information,Experiance:widget.Experiance,chooseDate:widget.ChooseDate,phoneuser:widget.phoneuser,phoneworker:widget.phoneworker,image:widget.image,description:widget.description,datesend:widget.datesend,timesend:widget.timesend,id:widget.id,phone:widget.phoneworker,date:widget.date,namefirst: widget.namefirst,namelast:widget.namelast,time:widget.time,),);
        });
  }
}
